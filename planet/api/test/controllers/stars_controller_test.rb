...
class StarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create star" do
    assert_difference('Star.count') do
      post stars_url, params: { star: { length: @star.length, name: @star.name, width: @star.width } }
    end
  ...
  test "should update star" do
    patch star_url(@star), params: { star: { length: @star.length, name: @star.name, width: @star.width } }
